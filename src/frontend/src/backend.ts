...
export class Backend implements backendInterface {
    ...
    async addCategory(arg0: Category): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getProductsByFilter(arg0: string, arg1: boolean): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsByFilter(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
